...
public class TestConstants {
    ...
    public static final String JSON_STRING = "{" + COLUMN_NAME + " : '" + COLUMN_VALUE + "'}";
    public static final String JSON_STRING_UPDATE = "{" + COLUMN_NAME + " : '" + COLUMN_VALUE_UPDATE + "'}";

    public final static String DEFAULT_PROFILE = "default";
    public final static String TEST_PROFILE = "cocoon";
